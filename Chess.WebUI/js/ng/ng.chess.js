(function () {
    'use strict';
    var app = angular.module('nywton.chess', ['nywton.chessboard']);

    app
        .service('NywtonChessGameService', [
            '$log', function ChessGameService($log) {
    ...
    app.directive('nywtonChessgame', [
        '$window', '$log', 'NywtonChessGameService', function ($window, $log, ChessGameService) {
            var directive = {
                restrict: 'E',
                template: '<div>' +
                ...
                controller: [
                    '$scope', function chessgame($scope) {
    ...
    app.directive('nywtonAllowOnlyLegalMoves', [
        '$window', 'NywtonChessGameService', function($window, ChessGameService) {
            ...
            var directive = {
                ...
                controller: [
                    function AllowOnlyLegalMovesCtrl() {
    ...
    app.directive('nywtonRandomVsRandom', [
            '$timeout', '$window', 'NywtonChessGameService', function ($timeout, $window, ChessGameService) {
                ...
                var directive = {
                    ...
                    controller: [
                        '$scope', function randomVsRandom($scope) {

    ...
    .directive('modal', function () {
        return {
            ...
            template: function (elem, attr) {
                var text = attr.buttonText ? attr.buttonText : '';
                var result = '<a href="" ng-click="open(item)" class="btn btn-block btn-success btn-lg btn"><i class="glyphicon glyphicon-plus"></i>' + text + '</a>';
                return result;
            },
            link: function (scope) {
